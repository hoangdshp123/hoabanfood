...
public class SanphammoiAdapter extends RecyclerView.Adapter<SanphammoiAdapter.ItemHolder>{
    ...
    public SanphammoiAdapter(Context context, ArrayList<Sanpham> arraysp) {
    ...
    public ItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.dongrecyclerviewspmoi,null);
    ...
    public class ItemHolder extends RecyclerView.ViewHolder{
        ...
        public ItemHolder(final View itemView) {
            super(itemView);
            imghinhanhsp = itemView.findViewById(R.id.img_sanphammoi);
            txtv_tensp = itemView.findViewById(R.id.txtv_tenspmoi);
            txtv_giasp = itemView.findViewById(R.id.txtv_giaspmoi);
